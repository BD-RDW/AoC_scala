...
import y2016.day04_2.{calculate, decodeRoomname, isRealRoom, mapToRoomId, roomId}
...
class day04_2Test  extends FunSuite {
  ...
  test("Check roomname decode") {
    assert(decodeRoomname(roomId("qzmt-zixmtkozy-ivhz", 343, "")).name == "very encrypted name")
  }
}
